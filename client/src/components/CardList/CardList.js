...
function CardList() {
  ...
  const [tempArr, setTempArr] = useState([
    ...
    },
    {
      ...
      profPic:
        'https://www.hawtcelebs.com/wp-content/uploads/2018/04/ellie-goulding-at-fashioned-for-nature-exhibition-vip-preview-in-london-04-18-2018-12.jpg',
      roles: ['Vocalist', 'Guitarist', 'Drummer'],
